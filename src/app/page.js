            ...
            <div className="row justify-content-center">
                <div className="col-xl-8 col-lg-10">
                    <div className="tp-hero-content p-relative z-index-1 text-center mb-60">
                        <span className="tp-hero-subtitle">Welcome to Shofy Grocery!</span>
                        ...
                        <div className="tp-hero-btn">
                            <a href="https://shofy-grocery-next-js.vercel.app/" target='_blank' className="tp-btn-border">See Live Demos</a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div className="tp-hero-thumb-wrapper p-relative z-index-1">
                        ...
                        <div className="tp-hero-main-img w-img">
                            <Link href="https://shofy-grocery-next-js.vercel.app/" target='_blank'>
                              <img src="/assets/img/hero/hero-img.png" alt="theme-pure" />
                            </Link>
                        </div>
                        ...
                        <div className="tp-counter-item d-flex align-items-start mb-30">
                            ...
                            <div className="tp-counter-content">
                                <h4><span className="purecounter" data-purecounter-duration="1" data-purecounter-end="7000">
                                    <Count number={12000} add_style={true} />
                                    </span>
                                </h4>
            ...
            <div className="row">
                <div className="col-xl-2 col-lg-3 col-md-4 col-sm-6">
                    <div className="tp-plugin-item text-center grey-bg mb-25" data-bg-color="#F8F8F8">
                        ...
                        <h3 className="tp-plugin-title">Next js <br/> (App Dir & SSR)</h3>
                    </div>
                </div>
                <div className="col-xl-2 col-lg-3 col-md-4 col-sm-6">
                    <div className="tp-plugin-item text-center grey-bg mb-25" data-bg-color="#F8F8F8">
                ...
                <div className="row">
                    <div className="col-xl-12">
                        <div className="tp-footer-content p-relative z-index-1 text-center">
                            <span className="tp-footer-subtitle">Shofy Grocery!</span>
                            ...
                            <div className="tp-footer-copyright">
                                <p>2024 © All rights reserved. Developed by <a href="https://themeforest.net/user/theme_pure">Theme Pure</a> </p>
                            </div>
                        </div>
                    </div>
                </div>
